...
{
    public partial class frmDSDatPhong : Form
    {
        ...
        private void frmDSDatPhong_Load(object sender, EventArgs e)
        {
            ...
            dGVDSOTro.Columns[1].Visible = false;
            dGVDSOTro.Columns[2].Visible = false;
            dGVDSOTro.Columns[3].Visible = false;
            ...
            dGVDSOTro.Columns[8].Visible = false;
            dGVDSOTro.Columns[10].Visible = false;
            ...
            dGVDSOTro.Columns[7].Width = 120;
            dGVDSOTro.Columns[12].Width = 200;
            dGVDSOTro.Columns[15].Width = 200;
            dGVDSOTro.Columns[16].Width = 200;
            dGVDSOTro.Columns[17].Width = 200;
        ...
        BLLQLDSTro BLLQLDSTro = new BLLQLDSTro();
